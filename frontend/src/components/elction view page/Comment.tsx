...
const Comment: React.FC<ElectionResponse> = ({ election, fetchElection }) => {
  ...
  useEffect(() => {
    if (election.comments) {
      dispatch({ type: "SET_COMMENTS", payload: election.comments });
    }
  }, [election.comments]);
    ...
    if (newComment.trim()) {
      try {
        const response = await axios.post(
          `${request}/api/elections/${election._id}/comments`,
  ...
  const updateComment = async (id: string) => {
    try {
      await axios.put(
        `${request}/api/elections/${election._id}/comments/${id}`,
  ...
  const addReply = async (commentId: string) => {
    if (replyContent.trim()) {
      try {
        const response = await axios.post(
          `${request}/api/elections/${election._id}/comments/${commentId}/replies`,
  ...
  const updateReply = async (commentId: string, replyId: string) => {
    try {
      await axios.put(
        `${request}/api/elections/${election._id}/comments/${commentId}/replies/${replyId}`,
  ...
  const likeComment = async (id: string) => {
    ...
    try {
      const response = await axios.post(
        `${request}/api/elections/${election._id}/comments/${id}/like`,
        {},
        { headers: { Authorization: `Bearer ${userInfo?.token}` } }
      );
      dispatch({
  ...
  const dislikeComment = async (id: string) => {
    ...
    try {
      const response = await axios.post(
        `${request}/api/elections/${election._id}/comments/${id}/dislike`,
        {},
        { headers: { Authorization: `Bearer ${userInfo?.token}` } }
      );
      dispatch({
  ...
  const likeReply = async (commentId: string, replyId: string) => {
    ...
    try {
      const response = await axios.post(
        `${request}/api/elections/${election._id}/comments/${commentId}/replies/${replyId}/like`,
        {},
        { headers: { Authorization: `Bearer ${userInfo?.token}` } }
      );
      dispatch({
  ...
  const dislikeReply = async (commentId: string, replyId: string) => {
    ...
    try {
      const response = await axios.post(
        `${request}/api/elections/${election._id}/comments/${commentId}/replies/${replyId}/dislike`,
        {},
        { headers: { Authorization: `Bearer ${userInfo?.token}` } }
      );
      dispatch({
